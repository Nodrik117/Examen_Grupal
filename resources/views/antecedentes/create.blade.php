                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="alergia_antibiotico" id="alergia_antibiotico" class="form-control input-sm">
                                            <option value="1" {{ old('alergia_antibiotico') == 1 ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('alergia_antibiotico') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="alergia_anestesia" id="alergia_anestesia" class="form-control input-sm">
                                            <option value="1" {{ old('alergia_anestesia') == 1 ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('alergia_anestesia') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="diabetes" id="diabetes" class="form-control input-sm">
                                            <option value="1" {{ old('diabetes') == 1 ? 'selected' : '' }}>Sí</option>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="hipertension" id="hipertension" class="form-control input-sm">
                                            <option value="1" {{ old('hipertension') == 1 ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('hipertension') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="enfermedad_cardiaca" id="enfermedad_cardiaca" class="form-control input-sm">
                                            <option value="1" {{ old('enfermedad_cardiaca') == 1 ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('enfermedad_cardiaca') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
